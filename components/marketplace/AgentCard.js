  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          "0 20px 40px rgba(251, 237, 224, 0.08), 0 0 60px rgba(147, 112, 219, 0.08)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = "translateY(0)";
        e.currentTarget.style.borderColor = "rgba(251, 237, 224, 0.1)";
        e.currentTarget.style.boxShadow =
          "0 10px 20px rgba(251, 237, 224, 0.04)";
      }}
      onClick={() => {
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 30% 50%, rgba(147, 112, 219, 0.05) 0%, transparent 50%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div className="relative z-10 p-4">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow =
              "0 8px 16px rgba(147, 112, 219, 0.3)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "translateY(0)";
